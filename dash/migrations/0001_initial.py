    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('developer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dash.developerprofile')),
            ],
        ),
        migrations.AddField(
            model_name='developerprofile',
            name='uploaded_games',
            field=models.ManyToManyField(blank=True, to='dash.game'),
        ),
        migrations.CreateModel(
            name='GameAsset',
            fields=[
                ...
                ('designer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dash.designerprofile')),
            ],
        ),
        migrations.AddField(
            model_name='designerprofile',
            name='uploaded_assets',
            field=models.ManyToManyField(blank=True, to='dash.gameasset'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dash.user')),
            ],
        ),
        migrations.CreateModel(
            name='PlayerProfile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dash.gameasset')),
                ('game', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='dash.game')),
        ...
        migrations.AddField(
            model_name='developerprofile',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dash.user'),
        ),
        migrations.AddField(
            model_name='designerprofile',
            name='user',
